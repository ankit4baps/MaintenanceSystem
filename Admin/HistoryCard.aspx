<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="HistoryCard.aspx.cs" Inherits="Admin_HistoryCard" %>
            ...
            <td colspan="3">
                <asp:GridView ID="GridView4" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="time_entry" HeaderText="Worked Qty. Date" 
                            SortExpression="time_entry" />
                        <asp:BoundField DataField="machi_hr" HeaderText="Machine Working Hrs." 
                            SortExpression="machi_hr" Visible="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                    ...
                    SelectCommand="SELECT service_no, worked_qty, time_entry, shift, machi_name, machi_hr, remark FROM supplyProduction WHERE (service_no = @service_no)" 
