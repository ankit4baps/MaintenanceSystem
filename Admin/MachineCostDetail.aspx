<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="MachineCostDetail.aspx.cs" Inherits="Admin_MachineCostDetail" Title="Untitled Page" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td class="textStyle" style="text-align: right">
                Costing Parameter :</td>
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server">
                    <asp:ListItem>--Select--</asp:ListItem>
                    <asp:ListItem>Cost of Machines Per Hrs</asp:ListItem>
                    <asp:ListItem>Machine Cost</asp:ListItem>
                    <asp:ListItem>Electricity Cost</asp:ListItem>
                    <asp:ListItem>Tooling Cost</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2" align="center">
                ...
                AllowPaging="True" onrowupdating="GridView1_RowUpdating">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="File Name" SortExpression="Machine_pic_Name">
                            <EditItemTemplate>
                                <asp:FileUpload ID="fp1" runat="server" />
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# bind("Machine_pic_Name") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
