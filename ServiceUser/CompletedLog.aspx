<%@ Page Title="" Language="C#" MasterPageFile="~/ServiceUser/ServiceMaster.master" AutoEventWireup="true" CodeFile="CompletedLog.aspx.cs" Inherits="ServiceUser_CompletedLog" %>
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
                    ...
                    SelectCommand="SELECT service_no, service_req_by, service_details, service_comp_by, service_inspe_by, service_inspe_name FROM serviceDetails WHERE (service_status = 'Completed') AND (service_comp_by = @service_comp_by) ORDER BY service_no DESC">
                    <SelectParameters>
