<%@ Page Title="" Language="C#" MasterPageFile="~/SupportUser/SupportMaster.master" AutoEventWireup="true" CodeFile="ViewSupport.aspx.cs" Inherits="SupportUser_ViewSupport" %>
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="service_no" HeaderText="Edit" 
                            Text="View" DataNavigateUrlFormatString="EditLog.aspx?service={0}" />
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT service_no, service_req_by, service_details, service_inspe_by, service_inspe_name, service_comp_by, ank_flag, service_status FROM serviceDetails WHERE (ank_flag = @ank_flag) AND (service_status = 'Pending') ORDER BY service_no DESC">
                    <SelectParameters>
